...
func NewRouter(handler *Handler) *mux.Router {
	...
	api.HandleFunc("/", handler.Unisender.Initialization).Methods(http.MethodPost)

	api.HandleFunc("/webhook", handler.AmoClient.infoFromWebHook).Methods(http.MethodPost)
